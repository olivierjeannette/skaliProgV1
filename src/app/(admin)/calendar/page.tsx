...
const CATEGORY_CONFIG: Record<SessionCategory, { name: string; color: string; bgColor: string; icon: typeof Flame }> = {
  crossnfit: { name: "Cross'N Fit", color: 'text-red-500', bgColor: 'bg-red-500/20', icon: Flame },
  hyrox: { name: 'Hyrox', color: 'text-orange-500', bgColor: 'bg-orange-500/20', icon: Activity },
  hyrox_long: { name: 'Hyrox Long', color: 'text-amber-600', bgColor: 'bg-amber-600/20', icon: Activity },
  power: { name: 'Power', color: 'text-blue-600', bgColor: 'bg-blue-600/20', icon: Dumbbell },
  build: { name: 'Build', color: 'text-purple-500', bgColor: 'bg-purple-500/20', icon: Dumbbell },
  tactical: { name: 'Tactical', color: 'text-slate-700', bgColor: 'bg-slate-700/20', icon: Activity },
  hyrox_team: { name: 'Hyrox Team', color: 'text-green-500', bgColor: 'bg-green-500/20', icon: Heart },
};
